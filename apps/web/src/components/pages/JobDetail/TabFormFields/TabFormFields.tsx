...
import { useJobFormFields, useSaveFormFieldsMutation } from '../hook'
...
export function TabFormFields({ jobId, isDraft }: TabFormFieldsProps) {
  const styles = tabFormFields()
  const [isEditing, setIsEditing] = useState(false)
  const { data: fields = [], isLoading } = useJobFormFields(jobId, true)
  const { mutate: saveFields, isPending } = useSaveFormFieldsMutation(jobId)
